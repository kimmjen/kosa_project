...
describe('RegisterPage.vue', () => {
  ...
  // 테스트 - 폼의 입력과 데이터 모델의 바인딩을 검증하는 테스트
  ...
  // 테스트 - 제출 핸들러의 존재 여부를 확인하는 테스트
  it('should have form submit event handler `submitForm`', function () {
    const stub = jest.fn()
